...
export const COCKPIT_API_PROVIDER_NAME = "Newbee API";
export const COCKPIT_API_BASE_URL = "https://api.newbeeapi.com";

const LEGACY_NEWBEE_API_BASE_URL = "https://www.newbeeapi.com/v1";
const LEGACY_COCKPIT_API_BASE_URL = "https://chongcodex.cn/v1";
const COCKPIT_API_HIDDEN_BASE_URLS = [
