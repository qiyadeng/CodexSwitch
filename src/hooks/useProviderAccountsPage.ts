...
const COCKPIT_API_PROVIDER_NAME = 'Newbee API';
const COCKPIT_API_LEGACY_PROVIDER_NAMES = ['Cockpit Api', 'Cockpit API', 'New API'];
const COCKPIT_API_PROVIDER_MATCH_NAMES = [
  COCKPIT_API_PROVIDER_NAME,
  ...COCKPIT_API_LEGACY_PROVIDER_NAMES,
...
const isCockpitApiImportItem = (item: Record<string, unknown>): boolean => {
  ...
  return candidates.some((value) => {
    ...
    return Boolean(
      normalized &&
        COCKPIT_API_PROVIDER_MATCH_NAMES.some((expected) =>
